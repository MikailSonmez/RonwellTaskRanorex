...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("925b98b5-acd8-43de-bab6-26df9daf3b75", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='') on item 'HttpsWwwTrendyolComUyelikcbEqhttps.SomeText'.", repo.HttpsWwwTrendyolComUyelikcbEqhttps.SomeTextInfo, new RecordItemIndex(0));
            Validate.AttributeEqual(repo.HttpsWwwTrendyolComUyelikcbEqhttps.SomeTextInfo, "Text", "");
            Delay.Milliseconds(100);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'HttpsWwwTrendyolComUyelikcbEqhttps.SomeText' at Center.", repo.HttpsWwwTrendyolComUyelikcbEqhttps.SomeTextInfo, new RecordItemIndex(1));
            repo.HttpsWwwTrendyolComUyelikcbEqhttps.SomeText.Click();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Visible='True') on item 'HttpsWwwTrendyolComUyelikcbEqhttps.UEyeOl'.", repo.HttpsWwwTrendyolComUyelikcbEqhttps.UEyeOlInfo, new RecordItemIndex(2));
            Validate.AttributeEqual(repo.HttpsWwwTrendyolComUyelikcbEqhttps.UEyeOlInfo, "Visible", "True");
            Delay.Milliseconds(100);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='Üye Ol') on item 'HttpsWwwTrendyolComUyelikcbEqhttps.UEyeOl'.", repo.HttpsWwwTrendyolComUyelikcbEqhttps.UEyeOlInfo, new RecordItemIndex(3));
            Validate.AttributeEqual(repo.HttpsWwwTrendyolComUyelikcbEqhttps.UEyeOlInfo, "Text", "Üye Ol");
            Delay.Milliseconds(100);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'HttpsWwwTrendyolComUyelikcbEqhttps.UEyeOl' at 95;17.", repo.HttpsWwwTrendyolComUyelikcbEqhttps.UEyeOlInfo, new RecordItemIndex(4));
            repo.HttpsWwwTrendyolComUyelikcbEqhttps.UEyeOl.Click("95;17");
            Delay.Milliseconds(0);
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'ApplicationUnderTest.LoginEmail' at 210;2.", repo.ApplicationUnderTest.LoginEmailInfo, new RecordItemIndex(14));
            repo.ApplicationUnderTest.LoginEmail.Click("210;2");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Enabled='True') on item 'ApplicationUnderTest.LoginEmail'.", repo.ApplicationUnderTest.LoginEmailInfo, new RecordItemIndex(15));
            Validate.AttributeEqual(repo.ApplicationUnderTest.LoginEmailInfo, "Enabled", "True");
            Delay.Milliseconds(100);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Valid='True') on item 'ApplicationUnderTest.LoginEmail'.", repo.ApplicationUnderTest.LoginEmailInfo, new RecordItemIndex(16));
            Validate.AttributeEqual(repo.ApplicationUnderTest.LoginEmailInfo, "Valid", "True");
            Delay.Milliseconds(100);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Visible='True') on item 'ApplicationUnderTest.LoginEmail'.", repo.ApplicationUnderTest.LoginEmailInfo, new RecordItemIndex(17));
            Validate.AttributeEqual(repo.ApplicationUnderTest.LoginEmailInfo, "Visible", "True");
            Delay.Milliseconds(100);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Value='') on item 'ApplicationUnderTest.LoginEmail'.", repo.ApplicationUnderTest.LoginEmailInfo, new RecordItemIndex(18));
            Validate.AttributeEqual(repo.ApplicationUnderTest.LoginEmailInfo, "Value", "");
            Delay.Milliseconds(100);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Enabled='True') on item 'ApplicationUnderTest.LoginPasswordInput'.", repo.ApplicationUnderTest.LoginPasswordInputInfo, new RecordItemIndex(19));
            Validate.AttributeEqual(repo.ApplicationUnderTest.LoginPasswordInputInfo, "Enabled", "True");
            Delay.Milliseconds(100);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Valid='True') on item 'ApplicationUnderTest.LoginPasswordInput'.", repo.ApplicationUnderTest.LoginPasswordInputInfo, new RecordItemIndex(20));
            Validate.AttributeEqual(repo.ApplicationUnderTest.LoginPasswordInputInfo, "Valid", "True");
            Delay.Milliseconds(100);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Visible='True') on item 'ApplicationUnderTest.LoginPasswordInput'.", repo.ApplicationUnderTest.LoginPasswordInputInfo, new RecordItemIndex(21));
            Validate.AttributeEqual(repo.ApplicationUnderTest.LoginPasswordInputInfo, "Visible", "True");
            Delay.Milliseconds(100);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Value='') on item 'ApplicationUnderTest.LoginPasswordInput'.", repo.ApplicationUnderTest.LoginPasswordInputInfo, new RecordItemIndex(22));
            Validate.AttributeEqual(repo.ApplicationUnderTest.LoginPasswordInputInfo, "Value", "");
            Delay.Milliseconds(100);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Enabled='True') on item 'ApplicationUnderTest.LoginRegister.QButtonQButtonMediumQFluidQPrima'.", repo.ApplicationUnderTest.LoginRegister.QButtonQButtonMediumQFluidQPrimaInfo, new RecordItemIndex(23));
            Validate.AttributeEqual(repo.ApplicationUnderTest.LoginRegister.QButtonQButtonMediumQFluidQPrimaInfo, "Enabled", "True");
            Delay.Milliseconds(100);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Valid='True') on item 'ApplicationUnderTest.LoginRegister.QButtonQButtonMediumQFluidQPrima'.", repo.ApplicationUnderTest.LoginRegister.QButtonQButtonMediumQFluidQPrimaInfo, new RecordItemIndex(24));
            Validate.AttributeEqual(repo.ApplicationUnderTest.LoginRegister.QButtonQButtonMediumQFluidQPrimaInfo, "Valid", "True");
            Delay.Milliseconds(100);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Visible='True') on item 'ApplicationUnderTest.LoginRegister.QButtonQButtonMediumQFluidQPrima'.", repo.ApplicationUnderTest.LoginRegister.QButtonQButtonMediumQFluidQPrimaInfo, new RecordItemIndex(25));
            Validate.AttributeEqual(repo.ApplicationUnderTest.LoginRegister.QButtonQButtonMediumQFluidQPrimaInfo, "Visible", "True");
            Delay.Milliseconds(100);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Enabled='True') on item 'ApplicationUnderTest.LoginRegister.SocialAccountLoginButtons'.", repo.ApplicationUnderTest.LoginRegister.SocialAccountLoginButtonsInfo, new RecordItemIndex(26));
            Validate.AttributeEqual(repo.ApplicationUnderTest.LoginRegister.SocialAccountLoginButtonsInfo, "Enabled", "True");
            Delay.Milliseconds(100);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Valid='True') on item 'ApplicationUnderTest.LoginRegister.SocialAccountLoginButtons'.", repo.ApplicationUnderTest.LoginRegister.SocialAccountLoginButtonsInfo, new RecordItemIndex(27));
            Validate.AttributeEqual(repo.ApplicationUnderTest.LoginRegister.SocialAccountLoginButtonsInfo, "Valid", "True");
            Delay.Milliseconds(100);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Visible='True') on item 'ApplicationUnderTest.LoginRegister.SocialAccountLoginButtons'.", repo.ApplicationUnderTest.LoginRegister.SocialAccountLoginButtonsInfo, new RecordItemIndex(28));
